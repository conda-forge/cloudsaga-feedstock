...
Once the `conda-forge` channel has been enabled, `cloudsaga` can be installed with:

```
conda install cloudsaga
```

It is possible to list all of the versions of `cloudsaga` available on your platform with:
